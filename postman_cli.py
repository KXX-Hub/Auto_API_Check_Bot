...
def run_postman_collection(collection_name, collections_folder, environment_path, today_folder, max_lines):
    ...
    try:
        ...
        collection_output = util.remove_ansi_escape_codes(collection_output)

        # Capture and log any errors
        error_output = completed_process.stderr
        error_output = util.remove_ansi_escape_codes(error_output)
    ...
    collection_results_file = os.path.join(today_folder, collection_name)
